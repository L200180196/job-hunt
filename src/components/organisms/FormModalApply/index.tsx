                ...
                session ? (
                    <Dialog>
                        <DialogTrigger asChild>
                            { isApply === 1 ? (
                                <Button className="text-lg px-12 py-6 bg-green-500" size="lg" disabled>
                                    Applied
                                </Button>
                            ) : (
                                    ...
                                    <form onSubmit={form.handleSubmit(onSubmit)} className='space-y-6'>
                                        <div className='grid grid-cols-2 gap-6'>
                                            ...
                                            <FormField
                                                ...
                                                render={({ field }) => (
                                                    <FormItem>
                                                        <FormLabel>Current previous job title</FormLabel>
                                                        <FormControl>
                                                            <Input placeholder="What's your current previous job title" {...field} />
                                                        </FormControl>
                                                        <FormMessage />
                                                    </FormItem>
                                                )}
                    ...
                    <Button className="text-lg" size="lg" variant='outline' onClick={() => router.push('/signin')}>
                        Sign In First
                    </Button>
                )
            }
