...
const useJobs = (filter?: string[]) => {
    ...
    const { data, isLoading, error, mutate } = useSWR(`${jobPath}?category=${paramsCategory}`, fetcher, {revalidateOnMount: false})
